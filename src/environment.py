...
class OthelloEnv:
    ...
    def get_state(self):
        ...
        return torch.FloatTensor(state).unsqueeze(0).unsqueeze(0) # Formato (1, 1, 8, 8)
    ...
    def step(self, action_idx, player_id):
        ...
        done = not OthelloLogic.get_valid_moves(self.board, 1) and \
               not OthelloLogic.get_valid_moves(self.board, 2)
